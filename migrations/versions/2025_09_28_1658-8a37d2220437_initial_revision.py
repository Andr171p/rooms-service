...
Revision ID: 8a37d2220437
Revises: 
Create Date: 2025-09-28 16:58:46.822403
...
def upgrade() -> None:
    ...
    op.create_index('outbox_index', 'outbox_events', ['status', 'aggregate_id', 'dedup_key', 'partition_key'], unique=False)
    ...
    sa.ForeignKeyConstraint(['permission_id'], ['permissions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('member_id', 'permission_id', name='unique_member_permission')
    )
